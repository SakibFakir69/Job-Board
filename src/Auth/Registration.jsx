  ...
  return (
    <div className="bg-[#071400] m-16 p-14 rounded-2xl">
      ...
      <section className="flex  w-full justify-center  gap-x-6">
        <div className="flex-1 w-[442px] h-[682px] flex flex-col ">
          <div className="flex flex-col   justify-center items-center  gap-y-9 h-2/3  mt-10">
            <div className="-mt-5 flex flex-col justify-center items-center gap-y-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-[442px]">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex  gap-x-2 items-center">
                  {/* <input
                    type="checkbox"
                    className="border-2 border-green-500 bg-transparent size-4"
                  /> */}
                  <span className="border border-green-500 bg-transparent size-4"></span>
