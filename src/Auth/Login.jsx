              ...
              <div className="w-full mb-6">
                ...
                <div className="w-full relative">
                  ...
                  <input
                    ...
                    className="peer border-[#e5eaf2] border outline-none pr-12 py-3 w-full mt-1 focus:border-[#3B9DF8] transition-colors duration-300 rounded-[46px] bg-transparent text-[#abc2d3] px-10 pl-10"
                  />
