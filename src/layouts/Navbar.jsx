...
function Navbar() {
  ...
  return (
    ...
    className={`${ishome==='/' ? "bg-[#071400] py-16 h-[260px] -mt-8  " : " bg-[#071400] py-10 "}`}
      
    >
      <div className="h-20 w-20 z-40  bg-green-400 blur-3xl absolute"></div>

      <nav className=" flex  justify-around gap-x-36 px-14 ">
        <Link to={'/'}>
          <img
        ...
        <div className="flex justify-center items-center gap-x-8">
          <div className="border p-2 bg-[#FFFFFF1A] w-[345px] flex  h-[50px] rounded">
            <div className="p-1 ">
              <select className="text-white  -mt-1.5 p-1 bg-[#88888838] flex justify-center items-center  w-[122px] h-[36px] rounded">
          ...
          <Link to={'/auth/registration'} className="cursor-pointer">
           <button  className="cursor-pointer w-[122px] h-[42px] bg-[#05AF2B]  text-white rounded-full">
            {" "}
            Registration
          </button>
          </Link>
      ...
      {ishome === "/" && <p className="w-full border-2 border-white/5 opacity-60 py-1"></p>}

      {ishome === "/" ? (
        <div className=" w-[1920] flex justify-around items-center bg-[#071400] p-6">
